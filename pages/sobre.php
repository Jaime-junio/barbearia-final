...
<div class="fundo-degrade">
    ...
    <section class="historia">
        <div class="historia-content">
            ...
            <!-- Adicione mais detalhes ou eventos significativos conforme necessÃ¡rio -->
        </div>
    </section>
    <!-- Adicione esta seÃ§Ã£o abaixo da seÃ§Ã£o de histÃ³ria -->
    ...
    <!-- Adicione esta seÃ§Ã£o abaixo da seÃ§Ã£o de MissÃ£o e Valores -->
    ...
    <!-- Adicione esta seÃ§Ã£o abaixo da seÃ§Ã£o de Equipe -->
    ...
    <!-- Adicione esta seÃ§Ã£o abaixo da seÃ§Ã£o de Fotos e Ambiente -->
    ...
    <!-- Adicione esta seÃ§Ã£o abaixo da seÃ§Ã£o de Filosofia de Atendimento ao Cliente -->
    ...
    <section class="atualizacoes-novidades">
        <div class="atualizacoes-novidades-content">
            ...
            <!-- Adicione links para as redes sociais ou seÃ§Ãµes especÃ­ficas do site conforme necessÃ¡rio -->
        </div>
    </section>
    <!-- Adicione esta seÃ§Ã£o no final da pÃ¡gina "Sobre" -->
